...
def make_exe():
    ...
    # python_config.run_command = "from main import app; mainloop()"

    # Run a Python module as __main__ when the interpreter starts.
    # python_config.run_module = "<module>"

    # Run a Python file when the interpreter starts.
    python_config.run_filename = "/Users/ugn/Documents/Code/Commercial/overtitle/overtitle-build/main.py"

    # Produce a PythonExecutable from a Python distribution, embedded
    # resources, and other options. The returned object represents the
    # standalone executable that will be built.
    exe = dist.to_python_executable(
        name="overtitle-build",
    ...
    # context.
    exe.add_python_resources(exe.read_virtualenv(path="/Users/ugn/Documents/Code/Commercial/overtitle/overtitle-build/venv"))
